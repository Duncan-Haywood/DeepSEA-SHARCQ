...
def main():
    ...
    app.layout = html.Div([
        ...
        html.P("please keep your folder (pre-zip) under 8 gb or the application will fail, and you won't get results. We set file limit at approximately 4 gb since zip should cut file size in half"),
        html.P("it takes a few minutes for the ai to process all files"),
        dcc.Upload(html.Button("Upload zip folder"), max_size=4*10**9, filetypes=['zip']),
