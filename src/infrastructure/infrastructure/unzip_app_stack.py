...
class UnzipAppStack(Stack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.environment = dict(ZIPPED_QUEUE_NAME=self.zipped_queue.queue_name, UNZIPPED_BUCKET_NAME=self.unzipped_s3.bucket_name)


        # lambda function from docker image
        self.fn = lambda_.DockerImageFunction(self, "UnZipFunction",
